...
INSTALL_PATH=/home/cdac/src/cross
TARGET=arm-linux
LINUX_ARCH=arm
...
LINUX_KERNEL_VERSION=linux-5.9
...
if [ $USE_NEWLIB -ne 0 ]; then
    ...
    wget -nc https://www.kernel.org/pub/linux/kernel/v5.x/$LINUX_KERNEL_VERSION.tar.gz
    wget -nc https://ftp.gnu.org/gnu/glibc/$GLIBC_VERSION.tar.xz
fi
wget -nc https://ftp.gnu.org/gnu/mpfr/$MPFR_VERSION.tar.gz
